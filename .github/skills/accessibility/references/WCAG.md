...
<button type="button" [attr.aria-label]="closeLabel">×</button>
```
...
<!-- Angular (static ARIA) -->
<label for="email">Email address</label>
<input type="email" id="email" formControlName="email" aria-describedby="email-hint">
<p id="email-hint">We'll never share your email.</p>
```
...
<input
  ...
  [attr.aria-describedby]="showHint ? 'email-hint' : null">
<p id="email-hint" *ngIf="showHint">We'll never share your email.</p>
```
...
<!-- Angular (static ARIA) -->
<label for="email">Email</label>
<input type="email" id="email" formControlName="email" aria-invalid="true" aria-describedby="email-error">
<p id="email-error" role="alert">Please enter a valid email address.</p>
```
...
<p id="email-error" role="alert" *ngIf="isInvalid">Please enter a valid email address.</p>
```
...
```html
<!-- Angular (dynamic ARIA) -->
<div role="dialog" [attr.aria-modal]="isModal ? 'true' : null" [attr.aria-labelledby]="dialogTitleId">
  <h2 [id]="dialogTitleId">Confirm Action</h2>
  <!-- content -->
</div>
```
...
<!-- Angular (dynamic ARIA) -->
<div [attr.aria-live]="liveMode">Status update here</div>
...
<!-- Angular (dynamic ARIA) -->
<div [attr.aria-live]="isUrgent ? 'assertive' : 'polite'" role="alert">Error message here</div>
