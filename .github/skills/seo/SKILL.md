...
Al generar documentación SEO (sitemaps, guías, checklists, plantillas), aplicar las reglas en `.github/documentation/ORTHOGRAPHY-GUIDELINES.md` y añadir en el encabezado: "Ortografía verificada según .github/documentation/ORTHOGRAPHY-GUIDELINES.md".
