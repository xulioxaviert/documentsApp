...
## Nota de Ortografía para Customizations

Cuando se creen o editen archivos de personalización (`*.agent.md`, `SKILL.md`, `*.instructions.md`, `*.prompt.md`), incluir y aplicar las reglas de `.github/documentation/ORTHOGRAPHY-GUIDELINES.md`. Los archivos documentales deben incluir la línea: "Ortografía verificada según .github/documentation/ORTHOGRAPHY-GUIDELINES.md" en su encabezado.
