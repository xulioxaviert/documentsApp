...
Al generar informes, guías o runbooks relacionados con Core Web Vitals, aplicar las reglas en `.github/documentation/ORTHOGRAPHY-GUIDELINES.md` y añadir en el encabezado: "Ortografía verificada según .github/documentation/ORTHOGRAPHY-GUIDELINES.md".
---
