...
Cuando esta skill genere informes o artefactos documentales (audits, checklists, runbooks), aplicar las reglas en `.github/documentation/ORTHOGRAPHY-GUIDELINES.md`. Añadir en el encabezado la línea: "Ortografía verificada según .github/documentation/ORTHOGRAPHY-GUIDELINES.md".
